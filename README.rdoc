...
Vanities "introduces" the concept of the "vanity URL".  Similar to a vanity
 ...
 * specific products in an e-commerce system
   (www.exampleshop.com/products/19920 => www.exampleshop.com/buythis)
...
*REST-based models* - every model with which you want to use vanities MUST be made
a RESTful resource in your routes file (config/routes.rb).  This is absolutely required.

*Rails 3* - vanities is built on Rails 3.  It might work with older versions of Rails, but
...
*ActiveRecord* - vanities needs a table in the database to keep track of the individual
